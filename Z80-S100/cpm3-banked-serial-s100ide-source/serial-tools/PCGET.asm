...
BASE$PORT	EQU	0A0H		;>>> SETUP FOR S100Computers Board <<<
...
SIGNON:	DB	'Get a File from a PC using the S100Computers IO Board',13,10
	DB	'Zilog SCC Ports A0H & A2H. Requires RTS & CTS, 38,400 Baud.',13,10,'$'
MSG$INIT DB	'SCC Port B initilized to 38,400 Baud.',CR,LF,'$'
