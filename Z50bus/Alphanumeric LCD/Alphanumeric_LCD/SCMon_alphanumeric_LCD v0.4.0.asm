...
;   0x6B = Port B control
;
; SC129 simple digital I/O module set to address 0xA0
...
#DEFINE     Z80PIO              ;Use Z80 PIO
#ENDIF
#IFDEF      RC2014
kDataReg:   .EQU 0x98           ;PIO port A data register
kContReg:   .EQU 0x9A           ;PIO port A control register
#DEFINE     Z80PIO              ;Use Z80 PIO
#ENDIF
#IFDEF      Z280RC
...
#ENDIF
#IFDEF      SC129
kDataReg:   .EQU 0xA0           ;SC129 output port (data register)
#ENDIF
