...
; The program aids installation of XModem.com on to a RC2014 CP/M
; system.
...
Message:    .DB  "XModem.com is ready to be saved.",0x0D,0x0A
            .DB  "Start CP/M and enter SAVE 26 XM.COM",0x0D,0x0A
            .DB  0

Program:
#INSERTHEX  Includes/xmdm125.hex
ProgramEnd:
