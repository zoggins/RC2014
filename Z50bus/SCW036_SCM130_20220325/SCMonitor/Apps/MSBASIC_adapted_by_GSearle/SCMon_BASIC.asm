;==================================================================================
; Modified to be compatible with Small Computer Monitor 0.6.0 and SCWorkshop.
; Minor tweaks to Grant's version to fix syntax compatibility with SCWorkshop.
...
; Made above easily configurable with conditional assembly, see next few lines.
...
;#DEFINE    BUILD_GrantsOriginal
;#DEFINE    BUILD_for_SCMon_code2000_data4000
;#DEFINE    BUILD_for_SCMon_code2000_data8000
#DEFINE    BUILD_for_SCMon_code3000_data8000
;#DEFINE    BUILD_for_SCMon_code8000_dataA000


; Configure according to above selection
#IFDEF      BUILD_GrantsOriginal
kORG        .EQU 0x0150         ; BASIC code origin
kWRKSPC     .EQU 0x2045         ; BASIC Work space
kMonWarm    .EQU 0x0000         ; Monitor warm start
#ENDIF
#IFDEF      BUILD_for_SCMon_code2000_data4000
kORG        .EQU 0x2000         ; BASIC code origin
kWRKSPC     .EQU 0x4000         ; BASIC Work space
kMonWarm    .EQU 0x0014         ; SCMonitor warm start
#ENDIF
#IFDEF      BUILD_for_SCMon_code2000_data8000
kORG        .EQU 0x2000         ; BASIC code origin
kWRKSPC     .EQU 0x8000         ; BASIC Work space
kMonWarm    .EQU 0x0014         ; SCMonitor warm start
#ENDIF
#IFDEF      BUILD_for_SCMon_code3000_data8000
kORG        .EQU 0x3000         ; BASIC code origin
kWRKSPC     .EQU 0x8000         ; BASIC Work space
kMonWarm    .EQU 0x0014         ; SCMonitor warm start
#ENDIF
#IFDEF      BUILD_for_SCMon_code8000_dataA000
kORG        .EQU 0x8000         ; BASIC code origin
kWRKSPC     .EQU 0xA000         ; BASIC Work space
kMonWarm    .EQU 0x0014         ; SCMonitor warm start
#ENDIF
...
;<SCC>      LD      B,INITBE-INITAB+3 ; Bytes to copy
            LD      B,ZZZB      ;<SCC>   = INITBE-INITAB+3
...
INITAB:     JP      WARMST      ; Warm start jump
            ...
            .WORD   0xFFFE      ; Current line number (cold)   <SCC> was -2
...
PRNTOK:     XOR     A           ; Output "Ok" and get command
            ...
            CALL    PRS         ; Output "Ok"
GETCMD:     LD      HL,0xFFFF   ; Flag direct mode   <SCC> was -1
            LD      (LINEAT),HL ; Save as current line
...
;<SCC>      CP      2*(ZLEFT-ZSGN)-1  ; Adj' LEFT$,RIGHT$ or MID$ ?
            CP      ZZZA        ;<SCC>   = 2*(ZLEFT-ZSGN)-1
...
JJUMP1:     LD      IX,0xFFFF   ; Flag cold start   <SCC> was -1
            JP      CSTART      ; Go and initialise

MONOUT:     JP      $0008       ; output a char

MONITR:     JP      kMonWarm    ; Warm start Monitor   <SCC> original $0
...
; =====================================================================
;<SCC> Modifications to overcome expression limits of SCWorkshop v0.1.3

ZZZA1:      .EQU 2*ZLEFT-ZSGN   ;<SCC>
ZZZA:       .EQU ZZZA1-1        ;<SCC>   = 2*(ZLEFT-ZSGN)-1

ZZZB1:      .EQU INITBE-INITAB  ;<SCC>
ZZZB:       .EQU ZZZB1+3        ;<SCC>   = INITBE-INITAB
