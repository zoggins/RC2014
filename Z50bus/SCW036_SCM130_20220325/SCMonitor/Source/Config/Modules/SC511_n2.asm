...
; **  Module: SC511 #2 (serial and timer card for Z50Bus)             **
; **     and  SC521 #2 (serial card for Z50Bus                        **
; **********************************************************************

; SC511 contains a Z80 SIO and a Z80 CTC
...
; SC521 contains a Z80 SIO and hardware data clock 
; Lack of CTC is detected at runtime and SIO divider set to 64
