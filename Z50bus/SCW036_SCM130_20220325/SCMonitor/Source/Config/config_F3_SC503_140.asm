; **********************************************************************
; **  Build Small Computer Monitor Configuration SC503 & SC140        **
; **********************************************************************
...
kConfMinor: .SET '3'            ;Config: 1 to 9 = official, 0 = user
#DEFINE     CNAME "Z50Bus/Z180" ;Configuration name (max 11 characters)

; Hardware ID (use HW_UNKNOWN if not for a very specified product)
kConfHardw: .SET HW_Z50BUS3     ;Hardware identifier (if known)
...
#INCLUDE    Config\Modules\SC503.asm
