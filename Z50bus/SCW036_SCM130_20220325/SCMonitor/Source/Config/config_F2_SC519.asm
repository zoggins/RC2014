; **********************************************************************
; **  Build Small Computer Monitor Configuration SC519 (+518)         **
; **********************************************************************
...
kConfHardw: .SET HW_Z50BUS2     ;Hardware identifier (if known)
...
; SC518 Z80 CPU
#INCLUDE    Config\Modules\SC518.asm

; SC519 Z80 memory
#INCLUDE    Config\Modules\SC519.asm
