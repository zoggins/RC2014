...
; **  BIOS: SCWorkshop simulator                                      **
; **********************************************************************

; Bios constants - name and version number
#DEFINE     BNAME "SCWorkshop"  ;Bios name
kBiosID:    .EQU BI_SCW         ;Bios ID (use constant BI_xxxx)
kBiosMajor: .EQU 1              ;Bios version: revision
kBiosMinor: .EQU 3              ;Bios version: revision
...
;#INCLUDE   BIOS\SCWorkshop\Selftest.asm
#INCLUDE    BIOS\SCWorkshop\Terminal.asm
#INCLUDE    BIOS\SCWorkshop\Printer.asm
