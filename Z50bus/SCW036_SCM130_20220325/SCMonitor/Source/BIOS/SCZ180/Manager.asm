...
#DEFINE     BNAME "SCZ180"      ;Bios name
kBiosID:    .EQU BI_SCZ180      ;Bios ID (use constant BI_xxxx)
...
#INCLUDE    BIOS\SCZ180\Z180Support.asm
...
; ASCI (Z180's asychnronous serial commincations interface)
#IFDEF      INCLUDE_ASCI_n1
kASCIBase:  .SET kASCI1         ;I/O base address 
...
kASCIFlag:  .SET 0b10000000     ;Hardware flags = Z180 ASCI
ASCI_n1:
#INCLUDE    BIOS\Framework\Devices\ASCI.asm
#ENDIF
...
H_Init:     CALL Z180Init       ;Initialise Z180 CPU
            CALL F_Init         ;Use framework
...
;          ASCI (Z180) also requires port A to be odd number
Interfaces:
#IFDEF      INCLUDE_ASCI_n1
            .DW  ASCI_n1
#ENDIF
